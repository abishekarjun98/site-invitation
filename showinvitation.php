...
if(isset($_GET["ID"]))
{
	...
	$IDi=mysqli_real_escape_string($conn,$_GET["ID"]);//depending upon the link clicked, the id is sent to this page, so that the coressponding 
	//invitation is displayed

	$IDa=$IDi;

	$query= " SELECT*  FROM invitationdata WHERE ID = $IDa ";
...
<div class="acc">
<a href="accept_status.php?S_ID=<?php echo $IDi ;?>"><!-- invitation id is sent to acceptedpage, to get response-->
ACCEPT
</a>
</div>
 &nbsp
 <div class="rej">
<a href="reject_status.php?S_ID=<?php echo $IDi ;?>">
REJECT
</a>
...
<!-- helps to apply the selected fontsylt"-->
...
<div class="headerc"><!-- displaying the invitation content -->
<?php echo $c1->header ?>
</div>
